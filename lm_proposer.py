...
class GPT3_Proposer:
    ...
    def __init__(self, problem, use_default_hypotheses=False, single_max_length=SINGLE_SAMPLE_MAX_LENGTH,
                 engine_name='gpt-4o', temperature=0.7):
    ...
    def propose_hypotheses(self, X_A: List[str], X_B: List[str]):
        ...
        result = chatgpt_wrapper(**query_args)
        returned_text = result.choices[0].message.content
